...
## Project Idea
A simple and clean **To-Do List** web application that helps users manage daily tasks.  
Users can add, edit, delete, and mark tasks as completed, with data saved locally in the browser.
